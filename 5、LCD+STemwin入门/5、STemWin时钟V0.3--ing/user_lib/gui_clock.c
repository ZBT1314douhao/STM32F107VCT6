...
void display_clock()
{
    ...
    coor_x_hour_pointer = circle[0].center_x + (circle[0].raduis - 24) * COS_HOUR_SPACE(hour);
    coor_y_hour_pointer = circle[0].center_y + (circle[0].raduis - 24) * SIN_HOUR_SPACE(hour);
