...
static uint16_t GPIO_ReadInputData(GPIO_TypeDef* GPIOx);
...
void lcd_test(void)
{
	...
	for (i=0; *(str + i); i++)
	{
		lcd_putchar_16x24((16*i), 24, *(str + i), RED, BLACK);
	}
...
//	RCC_APB2PeriphClockCmd( LCD_WR_APB2Periph | LCD_RD_APB2Periph | LCD_CS_APB2Periph | 
//													LCD_RS_APB2Periph | LCD_DATA_APB2Periph, ENABLE);
